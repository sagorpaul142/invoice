              ...
              <v-row>
                <v-col cols="12" sm="12" md="12">
                  ...
                  <v-text-field
                    ...
                    :error-messages="
                      v$.discountPrice.$error
                        ? v$.discountPrice.$errors[0].$message
                        : ''
                    "
                  >
                  </v-text-field>
                  ...
                  <v-text-field
                    ...
                    @blur="v$.date.$touch"
                    :error-messages="
                      v$.date.$error ? v$.date.$errors[0].$message : ''
                    "
                  >
                  </v-text-field>
  ...
  setup() {
    ...
    const rules = {
      username: {
        ...
        isLetter: helpers.withMessage(
          "User name must be only letters",
          isLetter
        ),
  ...
  methods: {
    ...
    submitForm() {
      ...
      if (!this.v$.$error) {
        ...
        this.isLoading = true;
        axios
          .post("http://localhost:9000/orders", user)
          .then((response) => {
